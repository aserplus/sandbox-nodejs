const objectUnderTest = require('../../../app/algorithms/search/binarySearch.js');
    ...
    describe('performSearch()', () => {
        it('should return expected results for all scenarios', () => {
            ...
            scenarios.forEach((scenario) => {
                /* act */
                result = objectUnderTest.performSearch(scenario.provided.data, scenario.provided.target);
